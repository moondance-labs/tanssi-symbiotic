export const OPT_IN_ABI = [
  {
    type: "constructor",
    inputs: [
      { name: "whoRegistry", type: "address", internalType: "address" },
      {
        name: "whereRegistry",
        type: "address",
  ...
  },
  {
    type: "function",
    name: "increaseNonce",
    inputs: [{ name: "where", type: "address", internalType: "address" }],
    outputs: [],
    stateMutability: "nonpayable",
  },
  {
  ...
  { type: "error", name: "NotOptedIn", inputs: [] },
  { type: "error", name: "NotWhereEntity", inputs: [] },
  { type: "error", name: "NotWho", inputs: [] },
  { type: "error", name: "OptOutCooldown", inputs: [] },
  {
    type: "error",
