export const FACTORY_ABI = [
  ...
  },
  {
    type: "function",
    name: "blacklist",
    inputs: [{ name: "version", type: "uint64", internalType: "uint64" }],
    outputs: [],
    stateMutability: "nonpayable",
  },
  {
  ...
  },
  {
    ...
    outputs: [{ name: "entity_", type: "address", internalType: "address" }],
    stateMutability: "nonpayable",
  },
  {
    type: "function",
  ...
  },
  {
    ...
    name: "migrate",
    inputs: [
      { name: "entity_", type: "address", internalType: "address" },
  ...
  { type: "error", name: "AlreadyBlacklisted", inputs: [] },
  ...
  { type: "error", name: "OldVersion", inputs: [] },
  {
    type: "error",
