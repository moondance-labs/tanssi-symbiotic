...
import {Verification} from "@snowbridge/src/Verification.sol";
import {Assets} from "@snowbridge/src/Assets.sol";
...
import {Upgrade} from "@snowbridge/src/Upgrade.sol";
import {IInitializable} from "@snowbridge/src/interfaces/IInitializable.sol";
import {IUpgradable} from "@snowbridge/src/interfaces/IUpgradable.sol";
import {ERC1967} from "@snowbridge/src/utils/ERC1967.sol";
import {Address} from "@snowbridge/src/utils/Address.sol";
import {SafeNativeTransfer} from "@snowbridge/src/utils/SafeTransfer.sol";
import {Call} from "@snowbridge/src/utils/Call.sol";
import {Math} from "@snowbridge/src/utils/Math.sol";
...
} from "@snowbridge/src/Params.sol";

import {CoreStorage} from "@snowbridge/src/storage/CoreStorage.sol";
import {PricingStorage} from "@snowbridge/src/storage/PricingStorage.sol";
import {AssetsStorage} from "@snowbridge/src/storage/AssetsStorage.sol";
import {OperatorStorage} from "@snowbridge/src/storage/OperatorStorage.sol";
...
contract Gateway is IOGateway, IInitializable, IUpgradable {
    ...
    function _ensureAgentAddress(
        address agent
    ) internal view returns (bytes32 agentID) {
