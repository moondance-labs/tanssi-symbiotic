...
contract DeployProductionTest is Test {
    ...
    function testDeployWithBroadcast() public {
        ...
        (address middlewareAddress, address operatorRewardsAddress) = deployProduction.deploy();
        ...
        _checkAddressesAndRoles(middlewareAddress, operatorRewardsAddress, entities, initialAdmin);
    }
    ...
    function testDeployLocal() public {
        ...
        (address middlewareAddress, address operatorRewardsAddress) =
    ...
    function testCanReadChainConfigInMainnet() public {
        ...
        assertNotEq(operators.operator1PierTwo.name, "");
        assertNotEq(operators.operator1PierTwo.evmAddress, address(0));
        assertNotEq(operators.operator1PierTwo.operatorKey, bytes32(0));

        assertNotEq(operators.operator6Opslayer.name, "");
        assertNotEq(operators.operator6Opslayer.evmAddress, address(0));
        assertNotEq(operators.operator6Opslayer.operatorKey, bytes32(0));
    }
