...
contract MiddlewareTest is Test {
    ...
    function testGetOperatorPower() public {
        ...
        uint256 power = OBaseMiddlewareReader(address(middleware)).getOperatorPower(operator, address(vault));
    ...
    function testGetOperatorPowerForSpecificVaultsAndSubnetworks() public {
        ...
        uint256 power = OBaseMiddlewareReader(address(middleware)).getOperatorPower(operator, vaults);
    ...
    function testGetOperatorPowerAtForVault() public {
        ...
        uint256 power = OBaseMiddlewareReader(address(middleware)).getOperatorPowerAt(epochTs, operator, address(vault));
    ...
    function testGetOperatorPowerAtForSpecificVaultsAndSubnetworks() public {
        ...
        address[] memory vaults = new address[](1);
        vaults[0] = address(vault);
        uint256 power = OBaseMiddlewareReader(address(middleware)).getOperatorPowerAt(epochTs, operator, vaults);
